...
csv_file_path = 'gs://data_raw_pf/users.csv.gz'
...
df.to_csv('gs://data_clear/users_clear.csv.gz',compression='gzip',index=False)
eliminar_archivo_gs('data_raw_pf','users.csv.gz')

## business

csv_file_path = 'gs://data_raw_pf/business.csv.gz'
...
df_business.to_csv('gs://data_clear/business_clear.csv.gz', index=False)
eliminar_archivo_gs('data_raw_pf','business.csv.gz')

print('aqui termina business')

## Tips

csv_file_path = 'gs://data_raw_pf/tip.csv.gz'
...
df_tip.to_csv('gs://data_clear/tip_clear.csv.gz', index= False)
eliminar_archivo_gs('data_raw_pf','tip.csv.gz')

## Reviews

csv_file_path = 'gs://data_raw_pf/reviews.csv.gz'
...
df_reviews.to_csv('gs://data_clear/reviews_clear.csv.gz',index='False')
eliminar_archivo_gs('data_raw_pf','reviews.csv.gz')
